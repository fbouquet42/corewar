...
/*   Updated: 2017/01/26 12:08:04 by jmichaud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_putldstr(char *str, long double value, int len, char base)
{
	...
	{
		str[--len] = tab[(intmax_t)value % base * sign];
		value /= base;
	}
	str[--len] = tab[(intmax_t)value % base * sign];
}

void			lajust_decimal(char **str)
{
	int			i;
	char		*nstr;
...
void			ft_lputdecimalstr(char **str, long double value, int precision)
{
	char		c;
	int			i;
